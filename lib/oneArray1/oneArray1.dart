...
import 'package:untitled/oneArray1/oneArrayPrediction1.dart';

class oneArray1 extends StatefulWidget {
  @override
  _oneArray1State createState() => _oneArray1State();
}
class _oneArray1State extends State<oneArray1> {
