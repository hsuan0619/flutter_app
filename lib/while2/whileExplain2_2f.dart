...
class whileExplain2_2f extends StatefulWidget {
  @override
  _whileExplain2_2fState createState() => _whileExplain2_2fState();
}
class _whileExplain2_2fState extends State<whileExplain2_2f> {
      ...
      floatingActionButton: SizedBox(
        ...
        FloatingActionButton(
          onPressed: () {
            ...
            {
              setState((){
                a='https://i.imgur.com/yKKQAgR.png';
                b=0.09;
              });
            }else
