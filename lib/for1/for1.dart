...
import 'package:untitled/for1/forPrediction1.dart';

class for1 extends StatefulWidget {
  @override
  _for1State createState() => _for1State();
}
class _for1State extends State<for1> {
