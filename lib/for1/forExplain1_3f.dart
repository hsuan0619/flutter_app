...
class forExplain1_3f extends StatefulWidget {
  @override
  _forExplain1_3fState createState() => _forExplain1_3fState();
}
class _forExplain1_3fState extends State<forExplain1_3f> {
      ...
      floatingActionButton: SizedBox(
        ...
        FloatingActionButton(
          onPressed: () {
            ...
            {
              setState((){
                a='https://i.imgur.com/gX1QxQF.png';
                b=0.12;
              });
            }else
