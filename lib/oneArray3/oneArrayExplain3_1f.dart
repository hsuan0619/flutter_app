...
class oneArrayExplain3_1f extends StatefulWidget {
  @override
  _oneArrayExplain3_1fState createState() => _oneArrayExplain3_1fState();
}
class _oneArrayExplain3_1fState extends State<oneArrayExplain3_1f> {
      ...
      floatingActionButton: SizedBox(
        ...
        FloatingActionButton(
          onPressed: () {
            ...
            {
              setState((){
                a='https://i.imgur.com/NbIFJEk.png';
                b=0.08;
              });
            }else
