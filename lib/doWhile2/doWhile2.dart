...
import 'package:untitled/doWhile2/doWhilePrediction2.dart';

class doWhile2 extends StatefulWidget {
  @override
  _doWhile2State createState() => _doWhile2State();
}
class _doWhile2State extends State<doWhile2> {
